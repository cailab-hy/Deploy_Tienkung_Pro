...
void Joystick_humanoid::xbox_flag_update(xbox_map_t xbox_map)
{
  ...
  // Policy switch: b alone (without e) = switch to SCENARIO2
  xbox_flag_.policy_switch_request = -1;
  if (xbox_map_.b == 1.0 && xbox_map_.e != 1.0) {
    xbox_flag_.policy_switch_request = 1;  // POLICY_SCENARIO2
  }
